...
const sideImages = [
  {
    src: "/images/gallery-wearer-cyber.png",
    alt: "Smart ring close-up",
    position: "left",
    span: 1,
  },
  {
    src: "/images/product-aura.png",
    alt: "Internal biosensors",
    position: "left",
    span: 1,
  },
  {
    src: "/images/product-catalyst.png",
    alt: "Haptic vest details",
    position: "right",
    span: 1,
  },
  {
    src: "/images/gallery-harness-outdoor.png",
    alt: "Biometric athlete profile",
    position: "right",
    span: 1,
  },
];
...
export function TechnologySection() {
  ...
  const descriptionText = "Experience wearable physiology reimagined with next-gen neural sync. Aura & Catalyst accessories merge micro-sensor loops, deep haptic feedback, and titanium grade-5 housing to elevate every peak performance state. From physical exertion to restorative sleep, your gear adapts dynamically.";
          ...
          >
            ...
            >
              <Image
                ...
                alt="Research facility biosensing core server grid"
                fill
                className="object-cover"
              />
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["Biometrics", "Meets", "Performance."].map((word, index) => {
