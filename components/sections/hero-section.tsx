...
const sideImages = [
  {
    ...
    alt: "Cyberpunk smart ring wearer",
    position: "left",
    span: 1,
  },
  {
    src: "/images/gallery-harness-outdoor.png",
    alt: "Athlete wearing biometric vest harness",
    position: "left",
    span: 1,
  },
  {
    src: "/images/gallery-glow-forest.png",
    alt: "Futuristic backpack glowing in forest",
    position: "right",
    span: 1,
  },
  {
    src: "/images/gallery-biometrics-ui.png",
    alt: "Biometrics telemetry visual dashboard",
    position: "right",
    span: 1,
  },
];
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              <Image
                src="/hero-main2.png"
                alt="Futuristic Kinesis Aura Ring glowing with cyan lighting"
                fill
                className="object-cover"
                priority
              />
